...
(function attachAriaControls() {
    ...
    // Try to detect the listbox generated by accessible-autocomplete
    var listbox =
        document.getElementById(idSelectField + '__listbox') ||
        document.querySelector('#' + idSelectField + '-listbox') ||
        document.querySelector('[role="listbox"]');

    if (listbox) {
        // Ensure listbox has an id (required by aria-controls)
        if (!listbox.id) {
            listbox.id = idSelectField + '__listbox';
        }

        // The following attributes added to improve screen read behaviour.
